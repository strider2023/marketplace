...
public class URLConstants {
    ...
    public static final String CONSUMER_GET_BUSINESS_INFO = "cb/consumer/entity/{businessId}";
    public static final String CONSUMER_GET_BUSINESS_PHOTO = "cb/consumer/entity/photos/{businessId}";
    public static final String CONSUMER_UPLOAD_BUSINESS_PHOTO = "cb/consumer/entity/photos/{businessId}/{photoId}";
    public static final String CONSUMER_DELETE_BUSINESS_PHOTO = "cb/consumer/entity/photos/{businessId}/{photoId}";
    public static final String CONSUMER_GET_BUSINESS_FEED = "cb/consumer/entity/feeds/{businessId}";
    public static final String CONSUMER_UPLOAD_BUSINESS_FEED = "cb/consumer/entity/feeds/{businessId}";
    public static final String CONSUMER_EDIT_BUSINESS_FEED = "cb/consumer/entity/feeds/{businessId}/{feedId}";
    public static final String CONSUMER_DELETE_BUSINESS_FEED = "cb/consumer/entity/feeds/{businessId}/{feedId}";
    public static final String CONSUMER_ADD_BOOKMARK = "cb/consumer/bookmark/{businessId}";
    public static final String CONSUMER_GET_BOOKMARKS = "cb/consumer/bookmark";
    public static final String CONSUMER_DELETE_BOOKMARKS = "cb/consumer/bookmark/{bookmarkid}";
}
