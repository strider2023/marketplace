...
public class ViewMyBusinessActivity extends AppCompatActivity implements ServerResponseListener{
    ...
    public void onAddFeed() {
        Intent intent = new Intent(this, AddBusinessFeedActivity.class);
